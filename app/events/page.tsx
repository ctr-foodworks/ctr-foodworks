...
export default function EventsPage() {
  ...
  return (
    <main className="flex flex-col w-full">
      ...
      <section
        id="private-events"
        className="w-full bg-[#f9f4f0] px-6 py-[80px] text-[var(--text-dark)] lg:px-[60px] lg:py-[120px]"
      >
      ...
      >
        <div className="mx-auto max-w-[1200px] flex flex-col gap-10 lg:gap-14">
          <div className="flex flex-col gap-5 lg:max-w-[640px]">
            <Eyebrow tone="primary">What&apos;s On</Eyebrow>
            ...
            <ul className="flex flex-col">
              {upcoming.map((evt) => {
                ...
                return (
                  <li
                    key={evt.slug}
                    className="grid grid-cols-1 gap-6 border-t border-white/10 py-8 last:border-b last:border-white/10 lg:grid-cols-[160px_1fr_auto] lg:items-center lg:gap-10"
                  >
                    {/* Date block */}
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <h3 className="font-display text-[24px] font-black uppercase leading-[1] tracking-[-0.5px] text-white lg:text-[28px]">
                        {evt.title}
                      </h3>
